...
public class ConsoleCommandAction implements MenuAction {
    ...
    public ConsoleCommandAction(LBmenu plugin, String command) {
        this.plugin = plugin;
    ...
    public void execute(Player player) {
        ...
        String finalCmd = cmd;
        plugin.getFoliaLib().getScheduler().runNextTick(task -> Bukkit.dispatchCommand(Bukkit.getConsoleSender(), finalCmd));
    }
}
